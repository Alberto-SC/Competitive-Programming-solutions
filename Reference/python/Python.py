#_________________________Exponentiation with decimal numbers_________________________#
import sys
...
#__________________________________REGEX________________________________________________#
