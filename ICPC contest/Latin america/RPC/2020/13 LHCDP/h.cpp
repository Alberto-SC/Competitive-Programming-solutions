        ...
        for(int i = 0;i<n;i++){
            for(int j = i+1;j<n;j++){
                for(int k = j+1;k<n;k++){
                    ...
                    triangulo[1] =  P[j];
                    triangulo[2] =  P[k];
                    // cout<<triangulo[0].x<<" "<<triangulo[0].y<<" "<<triangulo[1].x<<" "<<triangulo[1].y<<" "<<triangulo[2].x<<" "<<triangulo[2].y<<endl;
                    sort(triangulo.begin(),triangulo.end());
                    // cout<<area(triangulo)<<endl;
                    if(isgreater(area(triangulo),0))cont++;
                }
            }
        }
        cout<<cont<<endl;
