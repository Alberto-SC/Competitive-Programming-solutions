...
public class rglprecision {
  ...
  public static void main(String[] args) throws Exception {
    ...
    System.out.format("%.4f%n", new rglprecision(t,n,h,tables).solveProblem(0, h).toDouble());
  }

  final int t,n,h;
  final int[] tables;
  final Answer[][] solveProblemMemo;
  final Answer[][] getWaysMemo;

  public rglprecision(int t, int n, int h, int[] tables) {
    this.t = t;
    this.n = n;
    this.h = h;
    this.tables = tables;
    solveProblemMemo = new Answer[t][h+1];
    getWaysMemo = new Answer[t][t+h+1];
  }
  ...
  public Answer solveProblem(int s, int peopleLeft) {
    ...
    if (solveProblemMemo[s][peopleLeft] != null) {
      return solveProblemMemo[s][peopleLeft];
    }
    ...
    return (solveProblemMemo[s][peopleLeft] = res);
  }
  ...
  Answer getWays(int l, int r) {
    ...
    if (getWaysMemo[l][r] != null) {
      return getWaysMemo[l][r];
    }
