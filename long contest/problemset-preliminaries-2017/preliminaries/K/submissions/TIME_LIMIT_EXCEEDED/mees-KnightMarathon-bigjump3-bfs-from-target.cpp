...
bool operator==(const pt &l, const pt &r) { return l.x == r.x && l.y == r.y; }
bool operator<(const pt &l, const pt &r) { return l.x < r.x || (l.x == r.x && l.y < r.y); }
